...
window.onload = function() {
    ...
    //si el alto es mayor al ancho, usar VW en vez de vh para el tamaño del pokedex
    //esto permite que al girar el celular se vea el pokedex

    if (window.innerHeight > window.innerWidth) {
        $("#pokedex").attr('style', ' height: 100vw; width: 96.3vw;')
    } else {
        $("#pokedex").attr('style', ' height: 100vh; width: 96.3vh;')
    }
}

// //este es para que el cambio de tamaño del pokedex sea dinamico
